...
public class Fruit {
    ...
    public void displayInfo() {
        ...
        System.out.println("Nama Buah: " + this.getFruitName());
        System.out.println("Berat: " + this.getWeight());
        System.out.println("Harga: " + this.getPrice());
        System.out.println("Jumlah Beli: " + this.getQuantityPurchased() + "kg");
        System.out.println("Harga Sebelum Diskon: Rp" + currencyFormatter.format(this.calculatePriceBeforeDiscount()));
        System.out.println("Total Diskon: Rp" + currencyFormatter.format(this.calculateTotalDiscount()));
        System.out.println("Harga Setelah Diskon: Rp" + currencyFormatter.format(this.calculatePriceAfterDiscount()));
        System.out.println();
    }
}
